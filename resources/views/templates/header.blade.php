...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ asset('assets') }}/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Sistem</b>Lelang</span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('assets') }}/dist/img/rolando.jpg" class="img-circle" ="User Image">
                      </div>
                      <h4>
                        Support Team
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="{{ url('barang') }}">
            <i class="fa fa-file"></i> <span>Pendataan Barang</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="{{ url('tawar') }}">
            <i class="fa fa-gavel"></i> <span>Bid Barang</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
